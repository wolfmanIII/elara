...
final class Version20251201202624 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document_chunk (id UUID NOT NULL, chunk_index INT NOT NULL, content TEXT NOT NULL, embedding vector(1536) NOT NULL, file_id UUID NOT NULL, PRIMARY KEY (id))');
